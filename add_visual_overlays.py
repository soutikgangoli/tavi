#!/usr/bin/env python3
"""
Add visual overlays and integration files to Tavi Xcode project
"""
...
def main():
    ...
    # Files to add
    files_to_add = [
        ("HeatmapOverlayGenerator.swift", "Tavi/Features/FaceScan3D/Utilities/HeatmapOverlayGenerator.swift"),
        ("Face3DViewer.swift", "Tavi/Features/FaceScan3D/Views/Face3DViewer.swift"),
        ("Face3DSummary.swift", "Tavi/Features/FaceScan3D/Models/Face3DSummary.swift"),
        ("MetricExplanations.swift", "Tavi/Features/FaceScan3D/Utilities/MetricExplanations.swift"),
    ]
