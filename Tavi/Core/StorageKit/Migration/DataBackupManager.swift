...
public final class DataBackupManager: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.tavi.app", category: "DataBackup")
    ...
    public func exportBackup(_ backup: BackupInfo) throws -> URL {
        ...
        let exportURL = tempDirectory.appendingPathComponent("TaviBackup_\(Date().timeIntervalSince1970).sqlite")
