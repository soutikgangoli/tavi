...
public final class MemoryManagedResource<T> {
    ...
    private let logger = Logger(subsystem: "com.tavi.app", category: "MemoryManagedResource")
...
public final class MemoryResourceManager: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.tavi.app", category: "MemoryResourceManager")
