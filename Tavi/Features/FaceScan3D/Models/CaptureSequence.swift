...
public struct MeshCapture: Codable {
    ...
    public init(
        ...
        self.vertices = geometry.vertices.map { Vector3($0) }
        self.triangleIndices = geometry.triangleIndices
        self.normals = geometry.normals.map { Vector3($0) }
        self.textureCoordinates = geometry.textureCoordinates.map { Vector2($0) }
