//
//  FaceScan3DViewModelLegacy.swift
//  Tavi
//
//  LEGACY: Original monolithic ViewModel (kept as backup)
...
//
//  Original created on 2025-10-27.
//  Deprecated on 2025-11-04.
//
...
/// LEGACY: Main ViewModel for Face 3D scanning
/// This is the original monolithic implementation - kept as backup during transition
/// Use FaceScan3DViewModel (refactored) for new code
@available(*, deprecated, message: "Use the refactored FaceScan3DViewModel instead")
@MainActor
public class FaceScan3DViewModelLegacy: ObservableObject {
