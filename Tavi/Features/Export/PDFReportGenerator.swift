...
public class PDFReportGenerator {
    ...
    public func generateReport(
        ...
        // Create PDF context
        let pdfMetaData = [
            kCGPDFContextCreator: "Tavi - Clinical-Grade Skin Analysis",
            kCGPDFContextAuthor: "Tavi App",
    ...
    private func drawFooter(context: CGContext, pageSize: CGSize, pageNumber: Int) {
        ...
        // Text
        let footerText = "Page \(pageNumber) • Generated by Tavi • \(Date().formatted(date: .abbreviated, time: .omitted))"
