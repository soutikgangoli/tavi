...
public final class AdvancedMemoryMonitor: ObservableObject {
    ...
    public static let memoryWarningNotification = Notification.Name("OllvyAdvancedMemoryWarning")

    /// Memory pressure changed notification
    public static let memoryPressureChangedNotification = Notification.Name("OllvyMemoryPressureChanged")

    private var memoryWarningObserver: NSObjectProtocol?
    private var monitoringTimer: Timer?
    private let logger = Logger(subsystem: "com.ollvy.app", category: "AdvancedMemoryMonitor")
