...
public class PDFReportGenerator {
    ...
    private func drawPage4TechnicalData(
        ...
        let disclaimer = """
        This report is generated by Ollvy, a cosmetic skin appearance assessment app. The insights and recommendations are for informational and entertainment purposes only. This is NOT a medical device and does not provide medical diagnosis. Please consult with a qualified dermatologist for any skin concerns.

        Results are visual assessments and may vary based on lighting conditions and image quality.
